...
function MapEditor(jwdata) {
  ...
  this.map = new google.maps.Map(document.querySelector(element), mapOptions);
 ...
 * Build the map path
 */
MapForm.prototype.pathSet = function pathSet() {
 ...
 */
MapForm.prototype.addMarkerListener = function addMarkerListener(marker) {
  var _this = this,
    markerForm =
      '<div class="stop-form">' +
 ...
 */
MapForm.prototype.updateChart = function updateChart() {
 ...
 */
MapForm.prototype.addLines = function addLines(event, title, lat, lng) {
  var position,
  visible,
  _this = this;
...
MapForm.prototype.addMeetingPlace = function addMeetingPlace(latilongi, title, description, lat, lng) {
...
MapForm.prototype.addMarker = function addMarker(latilongi, title, description, questions, lat, lng) {
...
*/
MapForm.prototype.saveMarkerButton = function saveMarkerButton(marker) {
  var _this = this;
...
MapForm.prototype.initPoly = function initPoly() {
  var polyOptions = {
    strokeColor: '#F16725',
    strokeOpacity: 0.8,
    strokeWeight: 3,
...
MapForm.prototype.deleteMarkerButton = function deleteMarkerButton(marker) {
  var _this = this;
  google.maps.event.addListenerOnce(_this.infowindow, 'domready', function(){ 
...
MapForm.prototype.removeLines = function removeLines() {
  this.poly.binder.getAt(marker);
};

// Remove Stops and Path
MapForm.prototype.clearRoute = function clearRoute(event) {
...
MapForm.prototype.centerRoute = function centerRoute() {
  var _this = this;
