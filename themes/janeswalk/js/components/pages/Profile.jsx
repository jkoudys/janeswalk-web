...
import ProfileImpactReport from '../profile/ImpactReport.jsx';
...
export default class ProfilePageView extends PageView {
   ...
   * @return    void
   */
  _getBlogPostObjById(blogPostId) {
   ...
   * @return    void
   */
  _showEmailShareWindow(subject, body) {
   ...
   * @return    void
   */
  _showFacebookShareWindow(link, title, text) {
   ...
   * @return    void
   */
  _showTwitterShareWindow(link, text) {
