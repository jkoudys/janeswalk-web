...
},{"../Page.jsx":5}],7:[function(require,module,exports){
var PageView = require('../Page.jsx');
...
var HomePageView = PageView.extend({
  ...
  _addCityCalloutCta: function(cityName, cityPath) {
    React.render(
      ...
      React.createElement("h3", null, "See walks in ", React.createElement("a", {href: cityPath}, cityName), ", or:")
    );
  },
...
},{"../Page.jsx":5}],8:[function(require,module,exports){
var PageView = require('../Page.jsx');
